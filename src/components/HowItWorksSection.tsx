...
const steps = [
  {
    ...
    number: "01",
    title: "Text us",
    description: "Send a message to start. We'll ask your name and your ONE non-negotiable habit.",
    emoji: "📱",
  },
  {
    icon: Target,
    number: "02",
    title: "Set your 1 Thing",
    description: "Pick the habit you actually want to stick with this winter. Keep it real.",
    emoji: "🎯",
  },
  {
    icon: CheckCircle2,
    ...
    description: "Text 'check in' and we'll hold you accountable. No cap, just results.",
    emoji: "✅",
  },
];
